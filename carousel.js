        ...
        _getCoordinates: function (position) {
            if (this.support3d) {
                switch (position) {
                    ...
                    case 'left':
                        return {
                            '-webkit-transform': 'translateX(-' + (this.CSSX + 100) + 'px) translateZ(-300px) rotateY(25deg) scale(0.4)',
                            '-moz-transform': 'translateX(-' + (this.CSSX + 100) + 'px) translateZ(-300px) rotateY(25deg) scale(0.4)',
                            '-o-transform': 'translateX(-' + (this.CSSX + 100) + 'px) translateZ(-300px) rotateY(25deg) scale(0.4)',
                            '-ms-transform': 'translateX(-' + (this.CSSX + 100) + 'px) translateZ(-300px) rotateY(25deg) scale(0.4)',
                            'transform': 'translateX(-' + (this.CSSX + 100) + 'px) translateZ(-300px) rotateY(25deg) scale(0.4)',
                            'opacity': 0.5,
                            'visibility': 'visible',
                            'z-index': 2
                        };
                    ...
                    case 'center':
                        return {
                            '-webkit-transform': 'translateX(0px) translateZ(0px) rotateY(0deg) scale(1)',
                            '-moz-transform': 'translateX(0px) translateZ(0px) rotateY(0deg) scale(1)',
                            '-o-transform': 'translateX(0px) translateZ(0px) rotateY(0deg) scale(1)',
                            '-ms-transform': 'translateX(0px) translateZ(0px) rotateY(0deg) scale(1)',
                ...
                switch (position) {
                    case 'outleft':
                        return {
                            '-webkit-transform': 'translate(-' + (this.CSSXout + 100) + 'px) scale(0.4)',
                            '-moz-transform': 'translate(-' + (this.CSSXout + 100) + 'px) scale(0.4)',
                            '-o-transform': 'translate(-' + (this.CSSXout + 100) + 'px) scale(0.4)',
                            '-ms-transform': 'translate(-' + (this.CSSXout + 100) + 'px) scale(0.4)',
                            'transform': 'translate(-' + (this.CSSXout + 100) + 'px) scale(0.4)',
                            'opacity': 0.5,
                            'z-index': 2
                        };
                    case 'outright':
                    ...
                    case 'left':
                        return {
                            '-webkit-transform': 'translate(-' + (this.CSSX + 100) + 'px) scale(0.5)',
                            '-moz-transform': 'translate(-' + (this.CSSX + 100) + 'px) scale(0.5)',
                            '-o-transform': 'translate(-' + (this.CSSX + 100) + 'px) scale(0.5)',
                            '-ms-transform': 'translate(-' + (this.CSSX + 100) + 'px) scale(0.5)',
                            'transform': 'translate(-' + (this.CSSX + 100) + 'px) scale(0.5)',
                            'opacity': 0.7,
                            'visibility': 'visible',
                            'z-index': 3
                        };
